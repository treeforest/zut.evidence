...
import (
	...
	grcpService "github.com/treeforest/zut.evidence/internal/service/did_resolver/grpc"
...
func init() {
	...
	port = flag.Int("port", 10003, "the grpc server port")
	flag.Parse()
...
func accessibleRoles() map[string][]int {
	...
	return map[string][]int{
		"/DIDResolver/CreateDID": requiredRoles,
		"/DIDResolver/GetDIDs":   requiredRoles,
		"/DIDResolver/RevokeDID": requiredRoles,
	}
}
...
func main() {
	...
	srv := did_resolver.New(conf.Default(), pb.NewWalletClient(walletClientConn))
