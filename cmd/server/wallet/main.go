...
import (
	...
	grcpService "github.com/treeforest/zut.evidence/internal/service/wallet/grpc"
...
func accessibleRoles() map[string][]int {
	...
	return map[string][]int{
		"/Wallet/GenerateKey":   requiredRoles,
		"/Wallet/DownloadKey":   requiredRoles,
		"/Wallet/GetPubKey":     requiredRoles,
		"/Wallet/GetPrivateKey": requiredRoles,
		"/Wallet/Sign":          requiredRoles,
		"/Wallet/Verify":        requiredRoles,
		"/Wallet/Encrypt":       requiredRoles,
		"/Wallet/Decrypt":       requiredRoles,
		// "/Wallet/EncryptByPubKey": []int{}, 允许在不登录的情况下进行访问
	}
}
